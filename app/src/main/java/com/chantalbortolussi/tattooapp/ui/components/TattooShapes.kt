...
object TattooShapes {
    ...
    fun getMoonPath(width: Float, height: Float): Path {
        ...
        path.quadraticBezierTo(sx, sy, sx + sw, sy)
        path.quadraticBezierTo(sx, sy, sx, sy + sw)
        path.quadraticBezierTo(sx, sy, sx - sw, sy)
        path.quadraticBezierTo(sx, sy, sx, sy - sw)
        path.close()
    ...
    fun getButterflyPath(width: Float, height: Float): Path {
        ...
        // Antennas
        path.moveTo(cx, cy - height * 0.2f)
        path.quadraticBezierTo(cx - width * 0.1f, cy - height * 0.4f, cx - width * 0.12f, cy - height * 0.45f)
        path.moveTo(cx, cy - height * 0.2f)
        path.quadraticBezierTo(cx + width * 0.1f, cy - height * 0.4f, cx + width * 0.12f, cy - height * 0.45f)
